...
public class Day22Tests
{
    ...
    public async Task PartOne()
    {
        ...
        var actual = target.PartOne();
        Assert.Equal(642125L, actual);
    }

    [Fact]
    public void PartTwoTest()
    {
        var target = new Day22(_testInput2);
        var actual = target.PartTwo();
        Assert.Equal(2758514936282235L, actual);
    }
    ...
    public async Task PartTwo()
    {
        ...
        var target = new Day22(input);
        var actual = target.PartTwo();
        Assert.Equal(1235164413198198L, actual);
    }
}
